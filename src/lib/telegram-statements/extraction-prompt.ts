...
export function buildTelegramStatementExtractionPrompt(
  ...
  return [
    ...
    "- 다만 추모/애도 문장은 '희생자', '고인', '명복', '추모', '기억' 같은 표현 자체를 target_subject와 stance_action으로 볼 수 있다. 공식 문건의 추모 자체가 단체의 입장이다.",
    "- 원문 전체가 여러 문장으로 이루어진 것은 displayable=false 사유가 아니다. 선택한 core_sentence 한 문장만 단독으로 완결되고 노출 가능하면 displayable=true다.",
    "- sentence_role이 context, notice, resource_intro이면 반드시 displayable=false, core_sentence=\"\"로 답한다.",
    "- sentence_role=tribute는 displayable=true 대상이다. 공식 문건에서 단체가 추모, 애도, 기억, 명복을 표하면 그 자체를 정치적·사회적 입장으로 본다.",
    ...
    "- tribute: 추모/기념/애도 중심. 공식 문건의 추모·애도 자체를 단체의 입장으로 본다.",
    "- resource_intro: 자료/영상/카드뉴스/월간지/보고서 소개",
    "",
    "displayable=true 조건:",
    "- 구체적 소재(target_subject)와 단체의 판단/요구/비판/환영/우려/연대/제안/추모/애도(stance_action)가 함께 드러난다.",
    "- 추모/애도 문장은 대상이 '희생자', '고인', 특정 인물, 특정 참사, 또는 문건 제목/맥락으로 드러나고 단체의 추모/애도 태도가 있으면 displayable=true다.",
    "- 첫 화면에 한 문장만 보여도 무엇에 대한 어떤 입장인지 이해된다.",
    "- 문장이 원문 안에서 완결되어 있고 링크/일정/문의 없이도 의미가 통한다.",
    "",
    "displayable=false 조건:",
    "- 단순 배경 설명, 행사 개최, 자료/영상 소개, 일정/신청/후원 안내, 인물 발언 소개 문장이다.",
    "- 단체의 판단, 요구, 태도, 추모, 애도 중 어느 것도 없거나, 무엇에 대한 입장인지 단독으로 모호하다.",
    "",
    "confidence 기준:",
    ...
    "- '대전 한화에어로스페이스 공장 폭발사고 희생자 분들의 명복을 빕니다.' => displayable=true, sentence_role=tribute",
    "- '희생자들의 명복을 빕니다.' => displayable=true, sentence_role=tribute",

...
const CONTEXTUAL_STANCE_RE =
  /(촉구|요구|규탄|비판|환영|우려|강조|밝혔|주장|제안|선언|결의|호소|반대|찬성|경고|고발|사과|철회|중단|멈추|보장|착수|추진|개혁|조사|규명|답하|책임|심판|쇄신|참사|침묵|짓밟|열겠|지키겠|만들겠|이어가겠|함께하겠|싸우겠|실현하겠|다하겠|바꾸겠|세우겠|나서|응할 것|해야 한다|해야 합니다)/;
const SENTENCE_END_RE =
  /(다|했다|하였다|합니다|했습니다|었습니다|였습니다|되었습니다|입니다|겠다|겠습니다|십시오|주십시오|바랍니다|하라|하라!|하라\.|것인가|겁니까|습니까|입니까|아닙니까|해야 한다|해야 합니다)[.!?。！？]?$/;

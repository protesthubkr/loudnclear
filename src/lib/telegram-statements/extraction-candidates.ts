...
const DISPLAYABLE_SENTENCE_END_RE =
  /(?:습니다|합니다|됩니다|겠습니다|입니다|였다|했다|한다|하라|하십시오|마십시오|바랍니다|촉구합니다|촉구한다|요구합니다|요구한다|규탄합니다|규탄한다|제안합니다|제안한다|결의합니다|결의한다|투쟁합니다|투쟁한다|추모합니다|추모한다|애도합니다|애도한다|기억하겠습니다|기억하겠다|명복을 빕니다|이어가자|실현하자|보장하라|철회하라|중단하라|폐지하라|해체하라)[.!?。！？]*$/u;
